...
GetFollowupListModel getFollowupListModelFromJson(String str) => GetFollowupListModel.fromJson(json.decode(str));

String getFollowupListModelToJson(GetFollowupListModel? data) => json.encode(data!.toJson());

class GetFollowupListModel {
  GetFollowupListModel({
    this.message,
    this.result,
    this.isSuccess,
  });
  ...
  factory GetFollowupListModel.fromJson(Map<String, dynamic> json) => GetFollowupListModel(
