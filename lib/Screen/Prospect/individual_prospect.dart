...
class _IndividualProspectState extends State<IndividualProspect> {
  ...
  List<StageModel> stageList = [
    ...
    StageModel("Test2", Colors.grey, 2),
  ];
  ...
  GetAllProspectByIdtModel getAllProspectByIdtModel = GetAllProspectByIdtModel();
  @override
  void initState() {
    super.initState();
    ...
    attendanceRepository.getAllEmployeeList().then((value) {
      ...
      print(
          "my emp list from pros ${AttendanceRepository.employeeList[0].employeeId} ");
    });
        ...
        child: SafeArea(
          child: SingleChildScrollView(
            child: Column(children: [
              ...
              getAllProspectByIdtModel == null ?
              FutureBuilder<GetAllProspectByIdtModel>(
                future:
                prospectRepository.getAllProspectListByUserIdController(),
                                      ...
                                      children: [
                                        GestureDetector(
                                          onTap: (){
                                            ...
                                            print("stage string $statgeString");
                                          },
                                          child: CircleAvatar(

                                            radius:16,
                                            child: Text(snapshot.data!.result!.length.toString(),
                                              style: TextStyle(fontSize: 10), ),
                                          ),
                                        ),
                                        SizedBox(height: 5,),
                                        Text( "All", style: TextStyle(fontSize: 8),)
                                      ],
                                    ),
                                    Container(
                                      ...
                                      children: [
                                        GestureDetector(
                                          ...
                                          child: CircleAvatar(
                                            ...
                                            radius:16,
                                            child: Text(snapshot.data!.result!.where((element) => element.stage == "New prospect"&& element.isIndividual == true).length.toString(),
                                    ...
                                    Column(
                                      children: [
                                        GestureDetector(
                                          ...
                                          child: CircleAvatar(
                                            radius:16,
                                            child: Text(snapshot.data!.result!.where((element) => element.stage == "Step1"&& element.isIndividual == true).length.toString(),
                                              style: TextStyle(fontSize: 12),),

                                          ),
                                        ),
                                        SizedBox(height: 5,),
                                        Text("Step1", style: TextStyle(fontSize: 8),)
                                    ...
                                    Column(
                                      children: [
                                        ...
                                        GestureDetector(
                                          onTap: (){
                                            setState(() {
                                              statgeString ="Initial Contact";
                                            });
                                          },
                                          child: CircleAvatar(
                                            radius:16,
                                            child: Text(snapshot.data!.result!.where((element) => element.stage == "Initial Contact"&& element.isIndividual == true).length.toString(),
                                              style: TextStyle(fontSize: 12),),
                                          ),
                                        ),
                                        SizedBox(height: 5,),
                                    ...
                                    Column(
                                      children: [
                                        ...
                                        GestureDetector(
                                          onTap: (){
                                            setState(() {
                                              statgeString = "Visited";
                                            });
                                          },
                                          child: CircleAvatar(
                                            radius:16,
                                            child: Text(snapshot.data!.result!.where((element) => element.stage == "Visited"&& element.isIndividual == true).length.toString(),
                                              style: TextStyle(fontSize: 12),),
                                          ),
                                        ),
                                        SizedBox(height: 5,),
                                    ...
                                    Column(
                                      children: [
                                        ...
                                        GestureDetector(
                                          onTap: (){
                                            setState(() {
                                              statgeString =  "Already Client";
                                            });
                                          },

                                          child: CircleAvatar(
                                            radius:16,
                                            child: Text(snapshot.data!.result!.where((element) => element.stage == "Already Client"&& element.isIndividual == true).length.toString(),
                                              style: TextStyle(fontSize: 12),),
                                          ),
                                        ),
                                        SizedBox(height: 5,),
                                    ...
                                    Column(
                                      children: [
                                        ...
                                        GestureDetector(
                                          onTap:(){
                                            setState(() {
                                              statgeString = "On followup";
                                            });
                                          },
                                          child: CircleAvatar(
                                            radius:16,
                                            child: Text(snapshot.data!.result!.where((element) => element.stage == "On followup"&& element.isIndividual == true).length.toString(),
                                              style: TextStyle(fontSize: 12),),
                                          ),
                                        ),
                                        SizedBox(height: 5,),
                                    ...
                                    Column(
                                      children: [
                                        ...
                                        GestureDetector(
                                          onTap:(){
                                            setState(() {
                                              statgeString = "Hot Lead";
                                            });

                                          },
                                          child: CircleAvatar(
                                            radius:16,
                                            child: Text(snapshot.data!.result!.where((element) => element.stage == "Hot Lead"&& element.isIndividual == true).length.toString(),
                                              style: TextStyle(fontSize: 12),),
                                          ),
                                        ),
                                        SizedBox(height: 5,),
                            ...
                            Container(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (BuildContext context, index) {
                                  ...
                                  if (data.isIndividual == true && statgeString == "" ) {
                                    return Card(
                                  ...
                                  } else if(data.isIndividual == true && statgeString == data.stage) {
                                    return Card(
                                      child: ExpandableNotifier(
                ...
                height: MediaQuery.of(context).size.height - 250,
                child: ListView.builder(
                  itemCount: getAllProspectByIdtModel.result!.length,
                  itemBuilder: (BuildContext context, index) {
                    var data = getAllProspectByIdtModel.result![index];
                                    ...
                                    children: [
                                      GestureDetector(
                                        ...
                                        child: CircleAvatar(
                                          ...
                                          radius:16,
                                          child: Text(result!.where((element) => element.isIndividual == true).length.toString(),
                                            style: TextStyle(fontSize: 10), ),
                                        ),
                                      ),
                                      SizedBox(height: 5,),
                                    ...
                                    children: [
                                      GestureDetector(
                                        ...
                                        child: CircleAvatar(
                                          ...
                                          radius:16,
                                          child: Text(result!.where((element) => element.stage == "New prospect" && element.isIndividual == true).length.toString(),
                                            style: TextStyle(fontSize: 12), ),
                                        ),
                                      ),
                                      SizedBox(height: 5,),
                                  ...
                                  Column(
                                    children: [
                                      GestureDetector(
                                        ...
                                        child: CircleAvatar(
                                          radius:16,
                                          child: Text(result!.where((element) => element.stage == "Step1" && element.isIndividual == true).length.toString(),
                                            style: TextStyle(fontSize: 12),),
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      GestureDetector(
                                        ...
                                        child: CircleAvatar(
                                          radius:16,
                                          child: Text(result!.where((element) => element.stage == "Initial Contact" && element.isIndividual == true).length.toString(),
                                            style: TextStyle(fontSize: 12),),
                                        ),
                                      ),
                                      SizedBox(height: 5,),
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      GestureDetector(
                                        ...
                                        child: CircleAvatar(
                                          radius:16,
                                          child: Text(result!.where((element) => element.stage == "Visited" && element.isIndividual == true).length.toString(),
                                            style: TextStyle(fontSize: 12),),
                                        ),
                                      ),
                                      SizedBox(height: 5,),
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      GestureDetector(
                                        ...
                                        child: CircleAvatar(
                                          radius:16,
                                          child: Text(result!.where((element) => element.stage == "Already Client" && element.isIndividual == true).length.toString(),
                                            style: TextStyle(fontSize: 12),),
                                        ),
                                      ),
                                      SizedBox(height: 5,),
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      GestureDetector(
                                        ...
                                        child: CircleAvatar(
                                          radius:16,
                                          child: Text(result!.where((element) => element.stage == "On followup" && element.isIndividual == true).length.toString(),
                                            style: TextStyle(fontSize: 12),),
                                        ),
                                      ),
                                      SizedBox(height: 5,),
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      GestureDetector(
                                        onTap:(){
                                          setState(() {
                                            statgeString = "Hot Leads";
                                          });

                                        },
                                        child: CircleAvatar(
                                          radius:16,
                                          child: Text(result!.where((element) => element.stage == "Hot Leads" && element.isIndividual == true).length.toString(),
                                            style: TextStyle(fontSize: 12),),
                                        ),
                                      ),
                                      SizedBox(height: 5,),
                                      Text("Hot Leads", style: TextStyle(fontSize: 8),)
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      GestureDetector(
                                        onTap:(){
                                          setState(() {
                                            statgeString = "Demo Account";
                                          });

                                        },
                                        child: CircleAvatar(
                                          radius:16,
                                          child: Text(result!.where((element) => element.stage == "Demo Account" && element.isIndividual == true).length.toString(),
                                            style: TextStyle(fontSize: 12),),
                                        ),
                                      ),
                                      SizedBox(height: 5,),
                                      Text("Demo Account", style: TextStyle(fontSize: 8),)
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      GestureDetector(
                                        onTap:(){
                                          setState(() {
                                            statgeString = "Future prospect";
                                          });

                                        },
                                        child: CircleAvatar(
                                          radius:16,
                                          child: Text(result!.where((element) => element.stage == "Future prospect" && element.isIndividual == true).length.toString(),
                                            style: TextStyle(fontSize: 12),),
                                        ),
                                      ),
                                      SizedBox(height: 5,),
                                      Text("Future Prospect", style: TextStyle(fontSize: 8),)
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      GestureDetector(
                                        onTap:(){
                                          setState(() {
                                            statgeString = "Recycle Bin";
                                          });

                                        },
                                        child: CircleAvatar(
                                          radius:16,
                                          child: Text(result!.where((element) => element.stage == "Recycle Bin" && element.isIndividual == true).length.toString(),
                                            style: TextStyle(fontSize: 12),),
                                        ),
                                      ),
                                      SizedBox(height: 5,),
                                      Text("Bin", style: TextStyle(fontSize: 8),)
                          ...
                          Container(
                            ...
                            child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, index) {
                                ...
                                } else if(data.isIndividual == false && statgeString == data.stage) {
                                  return Card(
                                    child: ExpandableNotifier(
                                  ...
                                  Column(
                                    children: [
                                      GestureDetector(
                                        ...
                                        child: CircleAvatar(
                                          backgroundColor:   statgeString == "All" ? Colors.greenAccent : Colors.blue,
                                          radius:16,
                                          child: Text(result!.where((element) => element.isIndividual == true).length.toString(),
                                            style: TextStyle(fontSize: 10), ),
                                        ),
                                  ...
                                  Column(
                                    children: [
                                      GestureDetector(
                                        ...
                                        child: CircleAvatar(
                                          backgroundColor:   statgeString == "New prospect" ? Colors.greenAccent : Colors.blue,
                                          radius:16,
                                          child: Text(result!.where((element) => element.stage == "New prospect" && element.isIndividual == true).length.toString(),
                                            style: TextStyle(fontSize: 12), ),
                                        ),
                                  ...
                                  Column(
                                    children: [
                                      GestureDetector(
                                        ...
                                        child: CircleAvatar(
                                          backgroundColor:   statgeString == "Step1" ? Colors.greenAccent : Colors.blue,
                                          radius:16,
                                          child: Text(result!.where((element) => element.stage == "Step1" && element.isIndividual == true).length.toString(),
                                            style: TextStyle(fontSize: 12),),
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      GestureDetector(
                                        ...
                                        child: CircleAvatar(
                                          backgroundColor:   statgeString == "Initial Contact" ? Colors.greenAccent : Colors.blue,
                                          radius:16,
                                          child: Text(result!.where((element) => element.stage == "Initial Contact" && element.isIndividual == true).length.toString(),
                                            style: TextStyle(fontSize: 12),),
                                        ),
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      GestureDetector(
                                        ...
                                        child: CircleAvatar(
                                            backgroundColor:   statgeString == "Visited" ? Colors.greenAccent : Colors.blue,
                                          radius:16,
                                          child: Text(result!.where((element) => element.stage == "Visited" && element.isIndividual == true).length.toString(),
                                            style: TextStyle(fontSize: 12),),
                                        ),
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      GestureDetector(
                                        ...
                                        child: CircleAvatar(
                                          backgroundColor:   statgeString == "Already Client" ? Colors.greenAccent : Colors.blue,
                                          radius:16,
                                          child: Text(result!.where((element) => element.stage == "Already Client" && element.isIndividual == true).length.toString(),
                                            style: TextStyle(fontSize: 12),),
                                        ),
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      GestureDetector(
                                        ...
                                        child: CircleAvatar(
                                          backgroundColor:   statgeString == "On followup" ? Colors.greenAccent : Colors.blue,
                                          radius:16,
                                          child: Text(result!.where((element) => element.stage == "On followup" && element.isIndividual == true).length.toString(),
                                            style: TextStyle(fontSize: 12),),
                                        ),
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      GestureDetector(
                                        ...
                                        child: CircleAvatar(
                                          backgroundColor:   statgeString == "Hot Leads" ? Colors.greenAccent : Colors.blue,
                                          radius:16,
                                          child: Text(result!.where((element) => element.stage == "Hot Leads" && element.isIndividual == true).length.toString(),
                                            style: TextStyle(fontSize: 12),),
                                        ),
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      GestureDetector(
                                        ...
                                        child: CircleAvatar(
                                          backgroundColor:   statgeString == "Demo Account" ? Colors.greenAccent : Colors.blue,
                                          radius:16,
                                          child: Text(result!.where((element) => element.stage == "Demo Account" && element.isIndividual == true).length.toString(),
                                            style: TextStyle(fontSize: 12),),
                                        ),
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      GestureDetector(
                                        ...
                                        child: CircleAvatar(
                                          backgroundColor:   statgeString == "Future prospect" ? Colors.greenAccent : Colors.blue,
                                          radius:16,
                                          child: Text(result!.where((element) => element.stage == "Future prospect" && element.isIndividual == true).length.toString(),
                                            style: TextStyle(fontSize: 12),),
                                        ),
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      GestureDetector(
                                        ...
                                        child: CircleAvatar(
                                          backgroundColor:   statgeString == "Recycle Bin" ? Colors.greenAccent : Colors.blue,
                                          radius:16,
                                          child: Text(result!.where((element) => element.stage == "Recycle Bin" && element.isIndividual == true).length.toString(),
                                            style: TextStyle(fontSize: 12),),
                                        ),
