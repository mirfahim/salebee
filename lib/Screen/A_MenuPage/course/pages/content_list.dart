...
class ContentList extends StatefulWidget {
  ...
  @override
  State<ContentList> createState() => _EmployeeListState();
}

class _EmployeeListState extends State<ContentList> {
                            ...
                            itemBuilder: (BuildContext context, index){
                              return Card(
                                child: ListTile(
                                  ...
                                  subtitle: Text("Content des ajejoijfio eafjeioqjioeqwj fcoi"),
                                  leading: Image.asset("images/course/images/user_profile.jpg"),
