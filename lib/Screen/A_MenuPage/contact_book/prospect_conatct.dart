...
class ProspectContact extends StatefulWidget {
  const ProspectContact({Key? key}) : super(key: key);

  @override
  State<ProspectContact> createState() => _IndividualProspectState();
}

class _IndividualProspectState extends State<ProspectContact> {
  String searchString = "";
