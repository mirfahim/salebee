...
class AddTaskForm extends StatefulWidget {
  bool? followUp;
  AddTaskForm({this.followUp});
  @override
  State<AddTaskForm> createState() => _AddNewTaskState();
}

class _AddNewTaskState extends State<AddTaskForm> {
            ...
            child: FutureBuilder<GetListForTaskDataModel>(
                ...
                builder: (context, snapshot) {
                  ...
                  if (snapshot.hasError) {
                    ...
                    var dropdownValueSelectListEmployee =
                        snapshot.data!.result!["SelectListEmployee"]![0].text;
                    var dropdownValueSelectListLead =
                        snapshot.data!.result!["SelectListLeads"]!;
                    var statusList =
                        snapshot.data!.result!["SelectListTaskStatus"]!;
                    var dropdownValueSelectListSelectListStatus =
                        snapshot.data!.result!["SelectListTaskStatus"]![0].text;
                    var dropdownValueSelectListSelectListPriority =
                        snapshot.data!.result!["SelectListPriority"]![0].text;
                    return ExpandableNotifier(
                      child: ListView(
                        children: [
                          widget.followUp == false
                              ? Container(
                                  child: Column(
                                    crossAxisAlignment:
                          ...
                          widget.followUp == false
                              ? Container(
                                  decoration: BoxDecoration(
                                      ...
                                      color:
                                          primaryColorSecond.withOpacity(.4)),
                                  child: Padding(
                                                    ...
                                                    for (var element
                                                      ...
                                                      for (var con
                                                        ...
                                                        setState(() {
                                                          ...
                                                          print(
                                                              "my concern person list is ${concernPersonList.length.toString()}");
                                                          concernPerson =
                                                              concernPersonList[
                                                                  0];
                                                        });
                                                      ...
                                                      for (var lead
                                                        ...
                                                        setState(() {
                                                          ...
                                                          print(
                                                              "my leadlist list is ${leadList.length.toString()}");
                                                          leadName =
                                                              leadList[0];
                                                        });
                                                      }
