                      ...
                      if(snapshot.hasError){
                       return   ListView(
                         children: [
                           ...
                           Container(
                               ...
                               child:  Padding(
                                 ...
                                 child: DropdownButton<String>(
                                   isExpanded: true,
                                   value: dropdownValuePriority == null ? null :  type[dropdownValueType],
                          ...
                          print("my all list is __________________________${ snapshot.data!.result!["SelectListProspects"]![0].text}");
                        print("my all list is __________________________${ snapshot.data!.result!["SelectListEmployee"]![0].text}");
                        var dropdownValueSelectListEmployee =  snapshot.data!.result!["SelectListEmployee"]![0].text;
                        var dropdownValueSelectListLead =  snapshot.data!.result!["SelectListLeads"]![0].text;
                        var dropdownValueSelectListSelectListTaskStatus =  snapshot.data!.result!["SelectListTaskStatus"]![0].text;

                        var dropdownValueSelectListSelectListPriority =  snapshot.data!.result!["SelectListPriority"]![0].text;
                        return ListView(
                          children: [
                            Text('Task Title',style: TextStyle(
                                fontSize: 12,fontWeight: FontWeight.w400,color: text
                            ...
                            Container(
                                ...
                                child: Padding(
                                  ...
                                  child: DropdownButton<String>(
                                    isExpanded: true,
                                    value: dropdownValueSelectListSelectListPriority!,
                                    icon:Icon(Icons.arrow_drop_down_outlined),
                                    elevation: 16,
                                    style: const TextStyle(color: Colors.deepPurple),
                                    underline: Container(
                                    ...
                                    onChanged: (String? value) {
                                      ...
                                      snapshot.data!.result!["SelectListPriority"]!.map((e) {
                                        if (e.text == value)
                                          setState(() {
                                            dropdownValueSelectListEmployee = e.text;
                                          });
                                      });
                                    },
                                    items: snapshot.data!.result!["SelectListPriority"]!
                                        .map((value){
                                      return DropdownMenuItem<String>(
                            ...
                            Container(
                                ...
                                child: Padding(
                                  ...
                                  child: DropdownButton<String>(
                                    isExpanded: true,
                                    value: dropdownValueSelectListEmployee!,
                                    icon:Icon(Icons.arrow_drop_down_outlined),
                                    elevation: 16,
                                    style: const TextStyle(color: Colors.deepPurple),
                                    underline: Container(
                                    ...
                                    onChanged: (String? value) {
                                      // This is called when the user selects an item.
                                      print('taxGroup $value');
                                      snapshot.data!.result!["SelectListEmployee"]!.map((e) {
                                        if (e.text == value)
                                          setState(() {
                                            dropdownValueSelectListEmployee = e.text;
                                          });
                                    ...
                                    items: snapshot.data!.result!["SelectListEmployee"]!
                                        .map((value){
                                      return DropdownMenuItem<String>(
                                        value: value.text.toString(),
                                        child: Text(value.text.toString()),
                            ...
                            Container(
                                ...
                                child: Padding(
                                  ...
                                  child: DropdownButton<String>(
                                    isExpanded: true,
                                    value: dropdownValueSelectListLead!,
                                    icon:Icon(Icons.arrow_drop_down_outlined),
                                    elevation: 16,
                                    style: const TextStyle(color: Colors.deepPurple),
                                    underline: Container(
                                    ...
                                    onChanged: (String? value) {
                                      // This is called when the user selects an item.
                                      print('taxGroup $value');
                                      snapshot.data!.result!["SelectListLeads"]!.map((e) {
                                        if (e.text == value)
                                          setState(() {
                                            dropdownValueSelectListEmployee = e.text;
                                          });
                                    ...
                                    items: snapshot.data!.result!["SelectListLeads"]!
                                        .map((value){
                                      return DropdownMenuItem<String>(
                                        value: value.text.toString(),
                                        child: Text(value.text.toString()),
                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: DropdownButton<String>(
                                  isExpanded: true,
                                  value: dropdownValueSelectListSelectListTaskStatus,
                                  icon:Icon(Icons.arrow_drop_down_outlined),
                                  elevation: 16,
                                  style: const TextStyle(color: Colors.deepPurple),
                                  underline: Container(
                                  ...
                                  onChanged: (String? value) {
                                    // This is called when the user selects an item.
                                    print('taxGroup $value');
                                    snapshot.data!.result!["SelectListTaskStatus"]!.map((e) {
                                      if (e.text == value)
                                        setState(() {
                                          dropdownValueSelectListSelectListTaskStatus = e.text;
                                        });
                                    });
                                  },
                                  items: snapshot.data!.result!["SelectListTaskStatus"]!
                                      .map((value){
                                    return DropdownMenuItem<String>(
                                      value: value.text.toString(),
                                      child: Text(value.text.toString()),
