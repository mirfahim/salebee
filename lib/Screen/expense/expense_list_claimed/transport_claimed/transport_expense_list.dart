                            ...
                            snapshot.data!.result!.forEach((element) {
                              if(selectMonth == int.parse(element.createdOn.toString().substring(5,7)) && yearSelection == int.parse(element.createdOn.toString().substring(0,4))){
                               ...
                               list.forEach((ele) {
                                ...
                                print("total amount is  $totalBalance and ${list.length}");}
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: ListView.builder(
                                         ...
                                         if(selectMonth == int.parse(data.createdOn.toString().substring(5,7)) && yearSelection == int.parse(data.createdOn.toString().substring(0,4))){
                                           return  Container(
                                    ...
                                    GestureDetector(
                                        onTap: (){
                                          Navigator.of(context).push(
                                            MaterialPageRoute(
                                              builder: (builder) => PdfPreviewPage(invoice: snapshot.data!, monthSelection: selectMonth, yearSelection: yearSelection, ),
                                            ),
                                          );
                                        },
                                        child: Row(
