...
import 'package:salebee/Screen/lead/lead_details.dart';
...
class LeadView extends StatefulWidget {
  ...
  @override
  State<LeadView> createState() => _IndividualProspectState();
}

class _IndividualProspectState extends State<LeadView> {
  String searchString = "";
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      GestureDetector(
                                        ...
                                        child: CircleAvatar(
                                          radius:16,
                                          child: Text(result!.where((element) => element.stage == "Hot Lead" && element.isIndividual == false).length.toString(),
                                            style: TextStyle(fontSize: 12),),
                                        ),
                                      ),
                                      SizedBox(height: 5,),
