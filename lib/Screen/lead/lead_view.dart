...
import 'package:salebee/Screen/lead/create_lead.dart';
...
import '../../Model/lead/get_lead_model.dart';
...
class _IndividualProspectState extends State<LeadView> {
  ...
  GetLeadModel getAllLeadModel = GetLeadModel();
  @override
  void initState() {
    super.initState();
    Map <String, dynamic> prospectMap = jsonDecode(SharedPreff.to.prefss.getString("leadList")!);
    getAllLeadModel = GetLeadModel.fromJson(prospectMap);
    print("yo bro ${getAllLeadModel.result!.length.toString()}");
    result = _search(getAllLeadModel.result);
        ...
        child: SafeArea(
          child: SingleChildScrollView(
            child: Column(children: [
              ...
              getAllLeadModel == null ?
              FutureBuilder<GetLeadModel>(
                future:
                leaDRepository.getLeadController(),
                builder: (BuildContext context,
                    AsyncSnapshot<GetLeadModel> snapshot) {
  ...
  List<LeadResult> _search(List<LeadResult>? lead) {
    if (searchString.isNotEmpty == true) {
      //search logic what you want
      return lead
          ?.where((element) =>
          element.leadName!.toLowerCase().contains(searchString))
          .toList() ??
          <LeadResult>[];
    }
