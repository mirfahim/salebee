...
class LeadDetails extends StatefulWidget {
  ...
  LeadDetails({Key? key,this.prospectId, this.data, this.stage, this.prospectName, this.concernPerson, this.createdOn,this.assignto, this.createdby, this.industry, this.note} ) : super(key: key);

  @override
  State<LeadDetails> createState() => _ProspectDetailsState();
}

class _ProspectDetailsState extends State<LeadDetails> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  Text('Lead Details',style: TextStyle(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Expanded(
                        child: Text('Lead:',style: TextStyle(
